...
textkitFiles.forEach(file => {
    replaceInFile(file, [
        ...
        // Fix lastFont.unitsPerEm inside scale calculation
        ...
        // Fix the lastIndex condition ONLY in fontSubstitution
        [
